"""
Test file for the PrevYearWeek feature generator.
"""
...
def test_generate_features():
    """
    Test the generate_features function of PrevYearWeek.
    """
    ...
    prev_year_week_gen = PrevYearWeek(field_name_mapping=field_mapping, data=test_data)
    result = prev_year_week_gen.generate_features(test_data, feature_set=feature_set)
    
    print("PrevYearWeek Test Results:")
    print(f"Result shape: {result.shape}")
    print(f"Result columns: {list(result.columns)}")
    print(f"Result:\n{result}")
    
    # Expected values: average of sales from same week in previous year (52 weeks = 364 days ago)
    # Row 0 (2011-01-15): avg of sales from 2010-01-15 (30) = 30.0
    # Row 1 (2011-01-16): avg of sales from 2010-01-16 (32) = 32.0
    # Row 2 (2011-01-17): avg of sales from 2010-01-17 (34) = 34.0
    expected_values = [30.0, 32.0, 34.0]
    lag_column = '364_day_lag_sum'
    ...
    empty_result = prev_year_week_gen.generate_features(test_data, feature_set=None)
