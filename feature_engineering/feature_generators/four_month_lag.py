...
class FourMonthLag(FeatureGen):
    ...
    def __init__(self, field_name_mapping=None, data=None):
        ...
        """
        super().__init__(field_name_mapping, data, "FourMonthLag")
    ...
    def generate_features(self, data, feature_set=None):
        ...
        Returns:
            pandas.DataFrame: Feature set with four month lag features added
        """
        # Use the super class method to generate lag features average
        return self.generate_lag_features_avg(data, feature_set, [pd.Timedelta(days=i) for i in range(1, 121)])
